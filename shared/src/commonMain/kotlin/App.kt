...
fun BirdAppTheme(
    ...
    MaterialTheme(
        ...
        shapes = MaterialTheme.shapes.copy(
            small = AbsoluteCutCornerShape(5.dp),
            medium = AbsoluteCutCornerShape(5.dp),
            large = AbsoluteCutCornerShape(5.dp)
        )
    ) {
        content()
    }
...
fun BirdsPage(viewModel: BirdsViewModel) {
    ...
    Column(
        ...
        AnimatedVisibility(viewModel.uiState.value.isLoading) {
            Text("Loading...")
        }
        AnimatedVisibility(viewModel.uiState.value.error != null) {
            Text(viewModel.uiState.value.error!!)
        }
